...
interface FocoFlowNewPanelProps {
    activeModule?: string | null;
    onClose?: () => void;
}

const FocoFlowNewPanel: React.FC<FocoFlowNewPanelProps> = ({ activeModule, onClose }) => {
    return (
        <div className="flex flex-col h-full bg-[#05070B] text-slate-200 font-sans p-6 gap-6">
            <header className="flex justify-between items-end border-b border-slate-800 pb-6">
                <h1 className="text-3xl font-black tracking-tighter text-white uppercase flex items-center gap-3">
                    ...
                    {activeModule ? activeModule.toUpperCase() : 'FOCOFLOW PANEL'}
                </h1>
...
export default FocoFlowNewPanel;
